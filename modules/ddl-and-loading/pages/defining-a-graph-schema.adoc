...
image::image%20%282%29.png[Figure 2 - Expanded-User-Book-Rating schema with additional edges]
...
image::image%20%2813%29.png[Figure 3 - Outdegree stats illustration]
