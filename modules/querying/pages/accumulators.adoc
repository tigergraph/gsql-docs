...
* When a bitwise accumulator length less than 64 bit, it's assigned using one integer.
Each integer is a 64-bit sequence of 1s and 0s.
Overflow on the left is ignored.
* When a bitwise accumulator length is not 64 bit, it's assigned using an array of two integers.
Each integer is a 64-bit sequence of 1s and 0s.
