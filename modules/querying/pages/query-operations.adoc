...
Query descriptions explain the procedures for updating, showing, and dropping descriptions of queries and query parameters.
...
[source]
----
SHOW DESCRIPTION OF <objectType> <objectName(s)> [ON GRAPH <graphName>]
----
...
To remove a description, run the `DROP DESCRIPTION` command as shown below. This command can be used to remove the description of both global and local type objects, as well as queries and query parameters.
