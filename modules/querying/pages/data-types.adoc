...
[WARNING]
====
`STRING COMPRESS` is a deprecated data type.
...
[source,gsql]
----
include::appendix:example$work_net/datatypes_stringcompress.gsql[]
----
--
...
include::appendix:example$work_net/datatypes_stringcompress_results.json[]
----
--
====
