...
The output generated is in the same format as individual computation, with the `success` field tracking the total number of successful gathers and `failure` will track all of the failures encountered:
