...
. xref:#create_vector_schema[Add vectors to the graph schema].
. xref:#loading_vectors[Load vector data].
. xref:#vectorSearch[Search for similar vertices].
. xref:#print_vectors[Output selected vectors].
. You may also xref:#update_vectors[add or update vector data].
