...
[NOTE]
====
TigerGraph supports edge accumulators starting in 3.10.0, but only for Single GPR mode(a new internal engine framework for compiling non-distributed queries) query.
====
