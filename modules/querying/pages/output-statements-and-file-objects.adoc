...
xref:gsql-ref:ddl-and-loading:null-value.adoc[NULL values] can be printed using the `PRINT` statement and are represented as `null` in JSON and CSV output [v4.3+].
