...
If two HeapAccums hold the same types of tuple, and have the same sort order and direction, they are considered equivalent.

Capacity of the HeapAccum does not affect comparison.
