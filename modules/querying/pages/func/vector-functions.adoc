...
Vector Functions in TigerGraph are currently implemented as UDFs and preloaded as part of the Graph Data Science Library:
xref:3.9@graph-ml:similarity-algorithms:index.adoc[]


== Vector
=== tg_euclidean_distance_accum ()
====  Syntax
`tg_euclidean_distance_accum (VectorA, VectorB)`
...
=== tg_overlap_similarity_accum ()
==== Syntax
`tg_overlap_similarity_accum( VectorA, VectorB )`
...
=== pearson_similarity_accum ()
====  Syntax
`pearson_similarity_accum(VectorA, VectorB)`
...
====  Syntax
`tg_cosine_similarity(VectorA, VectorB)`
...
====  Syntax
`tg_jaccard_similarity()(VectorA, VectorB)`
