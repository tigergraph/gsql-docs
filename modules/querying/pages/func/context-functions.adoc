...
They work in: `INSTALLED` queries, `INTERPRET` queries, and xref:{page-component-version}@tigergraph-server:user-access:rbac-row-policy/rbac-row-policy.adoc#_gsql_functions[GSQL Functions].
...
To learn more about REST++ authentication see xref:{page-component-version}@tigergraph-server:API:authentication.adoc[REST API Authentication].
