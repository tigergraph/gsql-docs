...
In 4.3.0, `s3_region` allows you to explicitly set the S3 bucket region. If `s3_region` is not set, the default region is `us-east-1`.
If your bucket is located in a different region and `s3_region` is not set correctly, the query may fail.
