...
The user can disable this feature and perform regular referential integrity checking by using the `VERTEX_MUST_EXIST=true` option.
====
...
The following example checks if `$0 = 5`, with an error of 0.00001 permitted:
