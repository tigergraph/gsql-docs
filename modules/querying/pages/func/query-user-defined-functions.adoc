...
>>>>>>> 2a5b7ba7e03150937620bfae8fb5e1ec1c10f660
...
=======
If GitHub access is configured, GSQL will retrieve user source code files from GitHub before files uploaded via `PUT`, so long as the files exist. 
