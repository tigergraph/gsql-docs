...
BitwiseAndAccum and BitwiseOrAccum also support the following class functions.

[WARNING]
====
Mutator functions (those that modify the accumulator) can be used only under the following conditions:
