...
[source,bash]
----
curl -X GET "http://localhost:14240/gsql//gsql/v1/groups/g2"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET "Content-type: text/plain" "http://localhost:14240/gsql/scim/v2/Groups"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X PUT "Content-type: application/json" "http://localhost:14240/gsql/v1/groups/g1" -d '{"name": "g1", "rule": "rule1"}'
----
--
Sample Response::
+
