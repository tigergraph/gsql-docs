...
[source,bash]
----
curl -s -u tigergraph:tigergraph -X POST "localhost:14240/gsql/v1/queries/q1?graph=ldbc_snb" -H 'Content-Type: application/json' -d '{"diagnose":false,"denseMode":false,"allvertex":false,"asyncRun":false,"parameters":{p1:1}}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -s -u tigergraph:tigergraph -X POST "localhost:14240/gsql/v1/queries/q2?graph=ldbc_snb" -H 'Content-Type: application/json' -d '{"diagnose":false,"denseMode":false,"allvertex":false,"asyncRun":false,"parameters":{"p2":"30786325584978","p2.type": "Person"}}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -s -u tigergraph:tigergraph -X POST "localhost:14240/gsql/v1/queries/q3?graph=ldbc_snb" -H 'Content-Type: application/json' -d '{"diagnose":false,"denseMode":false,"allvertex":false,"asyncRun":false,"parameters":{"p3":"30786325584978"}}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -s -u tigergraph:tigergraph -X POST "localhost:14240/gsql/v1/queries/q4?graph=ldbc_snb" -H 'Content-Type: application/json'
-d '{"diagnose":false,"denseMode":false,"allvertex":false,"asyncRun":false,"parameters":{"p4":[["1", "Person"],["2", "Person"]]}}'
----
--
Sample Response::
+
