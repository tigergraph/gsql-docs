...
[source,bash]
----
curl -X GET "http://localhost:14240/gsql/v1/privileges"
----
--
Response::
+
...
[source,bash]
----
curl -X GET "http://localhost:14240/gsql/v1/privileges/grant?graph=g" -d "{"privileges":["READ_DATA", "CREATE_DATA", "UPDATE_DATA"], "vertexName": "user", "roles":["r1", "r2"]}"
----
--
Response::
+
