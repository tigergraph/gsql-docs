...
a|`-SINGLE`
|Enables a new internal framework for compiling non-distributed queries. Equivalent to the `single_gpr` session parameter described on the xref:basics:running-gsql.adoc#_session_parameters[Session Parameters page.]
