...
When writing a GSQL query with multi-hop `SELECT` statements, the xref:querying:select-statement/from-clause-v2.adoc#_path_pattern[path pattern (Syntax V2)] specified in the `FROM` clause is declarative.
