...
Here is a simple example to demonstrate how to apply Dynamic GSQL Query techniques, using the PageRank algorithm from our GSQL Graph Algorithm library. The query is written with schema information embedded statically in it:
