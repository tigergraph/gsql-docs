...
** a string or string set parameter which names one or more edge or vertex types  (*`paramName`*) This parameterized type is one aspect of xref:querying:create-and-install-queries.adoc[*Dynamic Querying*].
