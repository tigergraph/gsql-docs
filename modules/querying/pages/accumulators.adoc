...
[source,gsql]
----
include::appendix:example$minimal_net/accum_global_listaccum.gsql[]
----
--
...
include::appendix:example$minimal_net/accum_global_listaccum_results.json[]
----
--
====
...
[source,gsql]
----
include::appendix:example$minimal_net/accum_arrayaccum_local.gsql[]
----
--
...
include::appendix:example$minimal_net/accum_arrayaccum_local_results.json[]
----
--
====
