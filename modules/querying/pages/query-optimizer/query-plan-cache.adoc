...
After the query plan is generated, the query execution continues through other TigerGraph components. The overall execution time of an interpreted query therefore depends on additional factors beyond the query plan cache, including:
