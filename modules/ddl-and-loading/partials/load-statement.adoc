...
For more details on how to set up a Kafka data streaming connector and loading jobs, read the xref:3.8@tigergraph-server:data-loading:kafka-loader-user-guide.adoc[].
