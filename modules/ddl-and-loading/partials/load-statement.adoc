...
For more details on how to set up S3 data sources and loading jobs, read the xref:tigergraph-server:data-loading:s3-loader-user-guide.adoc[AWS S3 Loader User Guide].
