...
This page lists the limitations of GSQL's xref:querying:run-manage-queries.adoc#interpret-a-created-query[Interpreted mode].

To use the features on this page, xref:querying:create-and-install-queries.adoc#_install_query[install the query] and then run it instead.
