...
|
|
|Compares the bitwise accumulator with the given accumulator `arg_accum` and returns a new bitwise accumulator whose every bit is the `AND` result of the corresponding bits in the original accumulator and `arg_accum`, without modifying the original accumulator.

|`\|\|( arg_accum )`
|
|
|Compares the bitwise accumulator with the given accumulator `arg_accum` and returns a new bitwise accumulator whose every bit is the `OR` result of the corresponding bits in the original accumulator and `arg_accum`, without modifying the original accumulator.

|`^ ( arg_accum )`
|
|
|Compares the bitwise accumulator with the given accumulator `arg_accum` and returns a new bitwise accumulator whose every bit is the `XOR` result of the corresponding bits in the original accumulator and `arg_accum`, without modifying the original accumulator.

|`~ ( arg_accum )`
|
|
|Returns a new bitwise accumulator with every bit flipped (bitwise NOT) from the original accumulator, without modifying the original accumulator.
