...
To interpret, run, and manage queries during the *execution phase*, see xref:run-manage-queries.adoc[Run and Manage Queries].
...
* *Graph name:* When <<_create_query,creating a query>>, *`FOR GRAPH graphName`* is optional, as long as the graph has been specified already.
