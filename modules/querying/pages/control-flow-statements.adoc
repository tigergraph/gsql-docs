...
[source,gsql]
----
include::appendix:example$work_net/controlfow_while.gsql[]
----
--
...
[source,gsql]
----
GSQL > RUN QUERY company_count("us")
...
[source,gsql]
----
include::appendix:example$work_net/controlfow_querybody_foreach_2.gsql[]
----
--
