...
To use syntax v1, you need to declare the syntax at the query level or in a xref:tigergraph-server:get-started:gsql-shell/gsql-sessions.adoc#_session_parameters[session parameter].
