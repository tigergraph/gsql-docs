...
. Either stop all database activity or read carefully the section on xref:#_dynamic_schema_change_abilities_and_limitations[dynamic schema change] to see what concurrent activity is reasonable.
