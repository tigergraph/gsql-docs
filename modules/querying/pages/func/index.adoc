...
* xref:func/context-functions.adoc[Context functions]
...
* xref:func/list-functions.adoc[List functions]
...
* xref:func/query-user-defined-functions.adoc[Query user-defined functions]
* xref:func/string-functions.adoc[String functions]
* xref:func/type-conversion-functions.adoc[Type conversion functions]
* xref:func/vector-functions.adoc[Vector functions]
* xref:func/vertex-functions.adoc[Vertex functions]
