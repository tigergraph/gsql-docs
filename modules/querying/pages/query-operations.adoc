...
If you do not specify `-mode`, the system automatically selects the best mode, preferring instruction mode when possible.

.Example of interpreting a query with modes
