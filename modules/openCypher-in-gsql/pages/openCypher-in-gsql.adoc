...
|endNode() |Returns the end node of a relationship. Partially supported. See the note below for limitations.
...
|startNode() |Returns the start node of a relationship. Partially supported. See the note below for limitations.
