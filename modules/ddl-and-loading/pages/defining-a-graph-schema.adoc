...
[IMPORTANT]
An empty string is not a valid value for a vertex primary ID. Beginning with v3.7.1, GSQL will reject attempts to insert or load a vertex whose ID is an empty string.
...
Additional pairs of `FROM` and `TO` vertex types may be added.
