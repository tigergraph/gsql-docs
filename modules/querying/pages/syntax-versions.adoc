...
* In V2, the absence of a named edge set or a direction marker means any edge with any direction.
* In V3, `-` indicates any direction (left, right, or undirected) if is used as the directed brackets: `-[ ]-`
