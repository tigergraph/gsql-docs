...
to_string(12300000000::INT) -> "12300000000"  
to_string(12300000000::FLOAT) -> "1.23e+10"  
to_string(12300000000::DOUBLE) -> "1.23e+10"  
----
...
* *Scientific notation* is supported. For example, "1.45E-6" will be correctly interpreted as "1.45e-06".
