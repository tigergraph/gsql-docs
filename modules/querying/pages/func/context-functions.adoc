...
They work in: `INSTALLED` queries, `INTERPRET` queries, and xref:tigergraph-server:manage:access/rbac-row-policy/row-policy-concepts.adoc#_gsql_functions[GSQL Functions].
