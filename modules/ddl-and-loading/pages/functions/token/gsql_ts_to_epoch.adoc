...
In 3.10.4, two new timestamp conversion functions are available for loading jobs, offering different behaviors for date handling, especially for dates prior to 1970:
...
[%autowidth]
|===
|Function |Return type |Supported Time Range |Behavior |Description
