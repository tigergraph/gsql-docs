...
|MAP
`testMAP(MAP<STRING, INT> map_param)`
a|
[source,gsql]
----
RUN QUERY testMAP({"keylist":["A","B"],"valuelist":[10,20]})
----

|FILE
`testFILE(FILE file_param)`
a|
[source,gsql]
----
...
|VERTEX
`getEntityByVertex(VERTEX<Entity> vertex_param)`
a|
