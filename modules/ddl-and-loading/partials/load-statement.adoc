...
The `LOAD` statement has many options. This reference guide provides examples of key features and options. Tutorials such as the https://github.com/tigergraph/ecosys/blob/master/tutorials/GSQL.md#load-data[GSQL Tutorial] provide solution- and application-oriented examples.
