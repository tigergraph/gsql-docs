...
[source,gsql]
----
include::appendix:example$minimal_net/accum_listaccum_get_reference.gsql[]
----
--
...
include::appendix:example$minimal_net/accum_listaccum_get_reference_results.json[]
----
--
====
