...
=== log output
The following log details are displayed during query installation:
...
[NOTE]
====
These improvements are also displayed when installing 
queries during a TigerGraph upgrade.
====
