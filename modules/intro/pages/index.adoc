...
TigerGraph now also supports OpenCypher and the pattern matching portion of GQL, within the same execution engine.
This document presents the syntax and features for all of TigerGraph's query language support.
