...
You may want to consult the xref:tutorials:accumulators-tutorial.adoc[Accumulators Tutorial] and the GSQL Language Reference's section on  the xref:querying:select-statement/index.adoc#_accum_and_post_accum_clauses[ACCUM and POST-ACCUM clauses].
