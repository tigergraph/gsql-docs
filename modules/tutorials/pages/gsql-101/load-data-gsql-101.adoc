...
[NOTE]
In the default Docker installation described in xref:{page-component-version}@tigergraph-server:getting-started:docker.adoc[], these files are in the folder `/home/tigergraph/tutorial/3.x/gsql101/`
