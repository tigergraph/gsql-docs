...
The `-PROFILE` option allows you to activate query profiling when running a query in GSQL. Currently, the only supported value for profiling is `BASIC`, which enables basic query profiling to view and analyze execution details. 
