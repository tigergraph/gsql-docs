...
The Vector Search tutorial has list of link:https://github.com/tigergraph/ecosys/blob/master/tutorials/VectorSearch.md#vector-built-in-functions[built-in vector functions].
