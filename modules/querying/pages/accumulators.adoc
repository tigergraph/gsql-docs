...
To declare a `HeapAccum`, set the maximum capacity of the `HeapAccum`, and specify how the HeapAccum should be sorted.
...
The first parameter is the maximum number of tuples that the HeapAccum may store.
