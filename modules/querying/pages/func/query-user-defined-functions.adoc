...
All UDF files are scanned by the system to ensure that they comply with the UDF file policy as set in TigerGraph Server.
For more details, see xref:3.9@tigergraph-server:security:index.adoc[TigerGraph Server - Security].
