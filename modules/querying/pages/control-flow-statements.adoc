...
The iterating variable is treated as a copy existing only in the `FOREACH` statement. 
Modifying it will not modify any elements in the set or bag expression follwoing the keyword `IN`.
