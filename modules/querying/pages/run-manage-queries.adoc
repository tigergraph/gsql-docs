...
|===
|Parameter type / Query signature |Run query in GSQL

|BOOL
`testBOOL(BOOL bool_param)`
a|
[source,gsql]
----
...
|DATETIME
`testDATETIME(DATETIME datetime_param)`
a|
[source,gsql]
----
...
|DOUBLE
`testDOUBLE(DOUBLE double_param)`
a|
[source,gsql]
----
...
|STRING
`testSTRING(STRING string_param)`
a|
[source,gsql]
----
...
[cols="2,3", options="header"]
|===
|Parameter type / Query signature |Run query in RESTPP
...
[source,bash]
----
curl -X POST "http://localhost:14240/restpp/query/Entity_Resolution/testDATETIME" \
-d "datetime_param=2026-08-14 20:00:00"
----
