...
[source.wrap,gsql]
----
include::appendix:example$social_net/select_statement_index_where_using_edge_attributes.gsql[]
----
--
...
include::appendix:example$social_net/select_statement_index_where_using_edge_attributes_results.json[]
----
--
====
...
[source,gsql]
----
include::appendix:example$social_net/select_statement_index_three_post_accum_clauses.gsql[]
----
...
[source,gsql]
----
GSQL > RUN QUERY limit_ex_3(5,20)
