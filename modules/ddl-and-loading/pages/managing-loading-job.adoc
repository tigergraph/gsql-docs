...
| Token Bank Exception
| Exception thrown by functions within the token bank. This is a general error category for failures in user-defined functions and does not provide specific details about the cause.
|===
