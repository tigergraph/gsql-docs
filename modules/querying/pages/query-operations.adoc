...
[source,ebnf]
----
interpretQuery := INTERPRET QUERY [runOptions] "(" ")"
...
For [runOptions], refer to the syntax in the section xref:gsql-docs:querying:query-operations.adoc#_run_query[RUN QUERY].
