...
TigerGraph can load data from Parquet files using our Kafka loader.
For more details on how to set up a Kafka data streaming connector and loading jobs, read the xref:3.9.2@tigergraph-server:data-loading:kafka-loader-user-guide.adoc[].
