...
Not supported in a xref:tigergraph-server:data-loading:-loader/index.adoc[ loading job].
...
For more details on how to set up a Kafka data streaming connector and loading jobs, see xref:3.9@data-loading/data-loading-overview.adoc[].
