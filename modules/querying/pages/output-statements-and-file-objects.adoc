...
In 4.3, xref:4.3@gsql-ref:ddl-and-loading:null-value.adoc[NULL values] can be printed using the `PRINT` statement and are represented as `null` in JSON and CSV output.
