...
See Microsoft's documentation on link:https://learn.microsoft.com/en-us/cpp/cpp/left-shift-and-right-shift-operators-input-and-output[C++ bit shift operators] for more information.
