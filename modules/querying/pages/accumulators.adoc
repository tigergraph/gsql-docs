...
The BitwiseAndAccum and BitwiseOrAccum types store fixed-length bit sequences and calculate the cumulative result of a series of bitwise boolean operations and store the resulting bit sequences.
The default length for both BitwiseAndAccum and BitwiseOrAccum is 64 bits.
