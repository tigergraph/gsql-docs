...
CREATE QUERY count_employment_relationships() FOR GRAPH Work_Net {
...
----
# AvgAccum Example
CREATE QUERY avgAccumEx() FOR GRAPH Minimal_Net {
...
----
# AndAccum and OrAccum Example
CREATE QUERY andOrAccumEx() FOR GRAPH Minimal_Net {
  # T = True
  # F = False
...
[source,gsql]
----
CREATE QUERY bitwiseAccumEx() FOR GRAPH Minimal_Net {
...
----
# ListAccum Example
CREATE QUERY listAccumEx() FOR GRAPH Minimal_Net {
...
----
# BagAccum Example
CREATE QUERY bagAccumEx() FOR GRAPH Minimal_Net {
...
----
#MapAccum Example
CREATE QUERY mapAccumEx() FOR GRAPH Minimal_Net {
...
[source,gsql]
----
CREATE QUERY ArrayAccumElem() FOR GRAPH Minimal_Net {
...
[source,gsql]
----
CREATE QUERY ArrayAccumOp3(INT lenA) FOR GRAPH Minimal_Net {
...
----
#GroupByAccum Example
CREATE QUERY groupByAccumEx () FOR GRAPH Social_Net {
...
+
--
.Result for Query Group_By_Accum
[source,gsql]
----
...
[source,text]
----
CREATE QUERY nestedAccumEx() FOR GRAPH Minimal_Net {
