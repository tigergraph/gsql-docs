...
That is, the same name can be used in different graphs for vertex or edge types as long as they are not global vertex or edge types that are used by multiple graphs.
====
