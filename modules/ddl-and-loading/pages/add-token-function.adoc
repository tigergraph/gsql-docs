...
Use the xref:manage:management-with-gadmin.adoc#_gadmin_config_set[`gadmin config set`] command to configure the aforementioned parameters to connect GSQL to the GitHub repository hosting your files.
...
For more details, see xref:tigergraph-server:manage:security/index.adoc[TigerGraph Server - Security].
