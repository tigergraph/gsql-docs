...
You can place your functions in the `ExprFunctions` file provided as a sample in TigerGraph Server installations, or create your own file from scratch.
...
From then onwards, each time GSQL is run, it checks to see if the UDF files on GitHub have changed.
If they have, it downloads the new UDF files.
