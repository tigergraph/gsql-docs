...
* If the input is a string, the function tries to parse it into a boolean. For example, "true" becomes true, and "false" becomes false.
...
* If the input is a valid number in string format (e.g., "14.5"), the function converts it to a float (e.g., 14.5).
...
| `num`
| The number to convert into a float
| Number
|===
...
* If the input is a valid number in string format (e.g., "42"), the function converts it to an integer (e.g., 42).
...
| `num`
| The number to convert into an integer
| Number
|===
